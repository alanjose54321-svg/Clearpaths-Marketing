...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>About — Strativo</title><link rel="stylesheet" href="styles.css"/></head>
<body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
  <main class="page">
    <section class="page-hero"><h1>About Strativo</h1><p>We create clear, measurable marketing plans that grow businesses predictably.</p></section>
  ...
  <footer class="site-footer"><div class="footer-inner"><div><strong>Strativo</strong><p>Helping businesses find repeatable paths to growth.</p></div></div></footer>
</body>
</html>
'@
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Services — Strativo</title><link rel="stylesheet" href="styles.css"/></head>
<body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
  <main class="page">
  ...
  <footer class="site-footer"><div class="footer-inner"><div><strong>Strativo</strong></div></div></footer>
</body>
</html>
'@
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Digital Marketing — Strativo</title><link rel="stylesheet" href="styles.css"/></head>
<body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
  <main class="page">
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Our Work — Strativo</title><link rel="stylesheet" href="styles.css"/></head>
<body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
  <main class="page">
...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Contact — Strativo</title><link rel="stylesheet" href="styles.css"/></head>
<body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
  <main class="page">
...
"testimonials.html" = @'
<!DOCTYPE html>
<html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Testimonials — Strativo</title><link rel="stylesheet" href="styles.css"/></head><body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
...
"faq.html" = @'
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>FAQ — Strativo</title><link rel="stylesheet" href="styles.css"/></head><body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
...
"industries.html" = @'
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Industries — Strativo</title><link rel="stylesheet" href="styles.css"/></head><body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
...
"blog.html" = @'
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Insights — Strativo</title><link rel="stylesheet" href="styles.css"/></head><body>
  <header><nav class="nav"><div class="brand"><img src="img/logo2.png" class="logo" alt="Logo"><span>Strativo</span></div></nav></header>
